...
This section describes the set-up of our experiment, and argues
...
Workstation,
Docker, LXC, QEMU, KVM and Graphene. We also compared it against Native Linux and used
...
we conducted system call fuzzing (similar to our approach in \S{\ref{sec.metric}}) to obtain
