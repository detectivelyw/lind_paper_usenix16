...
negotiate between security and the need to provide basic functionality in order to
allow applications to run. In this section, we explore previous approaches to
...
execute untrusted applications in a manner that will not trigger bugs
