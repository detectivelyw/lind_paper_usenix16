...
\yiwen{The bug datasets are different for this section and section 6. And they are targeting 
two different kernel versions. One reason is these are two different studies conducted at 
different times. Another reason is that we do not want people to think our evaluation is 
tailored to what we have found in the metrics section. Using a different dataset for section 6 
provides a cross validation, which makes our results more convincing.}
...
\yiwen{want to give readers an idea of how long our experiments took. 
And by discrete, I mean the student was not working 20 hours continuously. 
The 20 hours time was accumulated during 5 days.}
...
\yiwen{The above description is mostly correct. The student did use the machine to 
do homework, programming, accessing the internet, and using emails. The student 
did not use Skype in our test. }
...
to compare unequal-sized code blocks. \yanyan{why code has to be equal sized?}
