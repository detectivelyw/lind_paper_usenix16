...
in v2.6.11 (March 2005) to 16.9 MLOC in v3.10 (June 2013)~\cite{Linux-13}.\lois{how
does the larger attack surface tie into its vulnerability?}
...
%The primary gsecure system is to restrict a program to a subset of privileges. Most systems mediate this access to
%the underlying operating system through a set of functions. Threats occur when applications obtain access to privileges
%that were not intentionally granted by the system, and thus the system loses the intended protection~\cite{Repy-10}.

A secure sandbox system can restrict a program to a subset of privileges.
%\gholami{I doubt this is the goal of the system. I think system goals are CIA properties that can be assured through confienment for example?}.
...
The following assumptions about potential threats were used to develop the proposed
 security metrics
