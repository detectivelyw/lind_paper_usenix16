...
A second limitation is that our criteria for determining if a kernel trace is safe or risky was to check it against a list of historical kernel bugs.  %However, not all bugs can be accurately checked in this manner.
